...
#include <iostream>
#include <math.h> 
#define FILAS 40 //Cantidad de puntos por 4 y redondeas para arriba
#define COLUMNAS 40
using namespace std;
...
void interpolacion (double m[FILAS][2], double x[FILAS], int filas, int medidaSubIntervalo);
	
	
	
int main(int argc, char *argv[]) {
	int subintervalo = 0;
	printf("Introduzca la cantidad de subintervalos: \n");
	scanf("%d", &subintervalo);
	double m[9][2] ={{1,0.098},{1.02,0.071},{1.10,-0.043},{1.23,-0.251},{1.35,-0.453},{1.5,-0.693},{1.7,-0.945},{1.86,-1.051},{2,-1.053}}; 
	int medSubInterv = 0;
	medSubInterv = (m[8][0]-m[0][0])/subintervalo;
	...
	interpolacion(m,x,filas,medSubInterv);
	return 0;
}
...
void interpolacion (double m[FILAS][2], double z[FILAS] ,int fila, int medSubInterv){
