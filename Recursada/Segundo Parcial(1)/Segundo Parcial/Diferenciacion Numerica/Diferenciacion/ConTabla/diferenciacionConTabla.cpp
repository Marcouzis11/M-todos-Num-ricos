...
#define FILAS 5  //CAMBIAR DEPENDIENDO LOS DATOS, SINO NO FUNCIONA
  ...
  else
  {
    ...
    do
    {
      ...
      case 1:
        ...
        case 1:
          cout << "Derivada primera por la DERECHA con un error de orden h2" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = -1; i < n - 1; i++)
          { //Si n=5 . i->4 .
            aprox = (y[i + 1] - y[i]) / h;
          ...
          cout << "Derivada primera por la DERECHA con un error de orden h4" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 0; i < n - 2; i++)
          {
        ...
        case 2:
          cout << "Derivada segunda por la DERECHA con un error de orden h2" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 0; i < n - 2; i++)
          {
          ...
          cout << "Derivada segunda por la DERECHA con un error de orden h4" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 0; i < n - 3; i++)
          {
        ...
        case 3:
          cout << "Derivada tercera por la DERECHA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 0; i < n - 3; i++)
          {
        ...
        case 4:
          ...
          cout << "Derivada cuarta por la DERECHA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 0; i < n - 5; i++)
          {
      ...
      case 2:
        ...
        case 1:
          cout << "Derivada primera CENTRADA con un error de orden h2" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 1; i < n - 1  ; i++)
          {
          ...
          cout << "Derivada primera CENTRADA con un error de orden h4" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 2; i < n - 2; i++)
          {
        ...
        case 2:
          cout << "Derivada segunda CENTRADA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 1; i < n - 1; i++)
          {
        ...
        case 3:
          cout << "Derivada tercera CENTRADA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 2; i < n - 2; i++)
          {
        ...
        case 4:
          cout << "Derivada cuarta CENTRADA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 2; i < n - 2; i++)
          {
      ...
      case 3:
        ...
        case 1:
          ...
          cout << "Derivada primera por la IZQUIERDA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 2; i < n; i++)
          {
        ...
        case 2:
          ...
          cout << "Derivada segunda por la IZQUIERDA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 3; i < n; i++)
          {
        ...
        case 3:
          ...
          cout << "Derivada tercera por la IZQUIERDA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 4; i < n; i++)
          {
        ...
        case 4:
          ...
          cout << "Derivada cuarta por la IZQUIERDA con un error de orden" << endl;
          printf("      x\t\t\t      y\n");
          for (int i = 5; i < n; i++)
          {
